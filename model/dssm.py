# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 16:06:44 2021
...
class DSSM(BaseTower):
    ...
    def __init__(self, user_dnn_feature_columns, item_dnn_feature_columns, gamma=1, dnn_use_bn=True,
        ...
        print("user_dim", compute_input_dim(user_dnn_feature_columns))
        if len(user_dnn_feature_columns) > 0:
            '''compute_input_dim: 特征向量维度'''
        ...
        print("items_dim", compute_input_dim(item_dnn_feature_columns))
